...
>
	...
	<p class="not-sr-only mx-auto hidden font-semibold select-none lg:block">Alacritty</p>
	<p class="not-sr-only mx-auto block font-semibold select-none lg:hidden">Imam Putra</p>
	<Face />
</header>
